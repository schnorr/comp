...
específicos para tal: como o /stack pointer/ =sp= e o /frame pointer/ =rarp=.
...
relevante é que tanto =rarp= (ponteiro do RA) =rsp= (ponteiro do topo da
...
Onde os endereços =rarp= e =rsp= são normalmente 0, mas o =rsp= deve
