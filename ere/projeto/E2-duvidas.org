...
positivo. Nem tem como, né? Veja que a expressão só seria avaliada em
tempo de execução (imaginando que ela depende de uma entrada ainda
desconhecida do compilador, o que é normalmente o caso).
...
R: Sim, é uma expressão válida de acordo com a especificação E2.
