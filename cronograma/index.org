...
| Sintática  | Parser LALR(1), AST e =bison= (ações)                       |             | Início E3 (Árvore)   |
...
| Semântica  | Esquemas S e L-Atribuídos                                 |             | Início E4 (Tipos)    |
| Semântica  | Implementação de Esquemas S e L-Atribuídos                |             |                      |
|            | Revisão                                                   |             |                      |
|            | P1 (presencial, G1 e G2)                                  | Auditório   |                      |
| Código     | Declarações, Escopos e Atribuição                         |             | Início E5 (Código)   |
| Código     | Expressões Lógicas com atalho, Controle de Fluxo          |             |                      |
| Projeto    | Acompanhamento (Presencial, G1)                           | Laboratório |                      |
| Projeto    | Acompanhamento (Presencial, G2)                           | Laboratório |                      |
| Código     | Endereçamento de Arranjos multidimensionais               |             | Início E6 (Assembly) |
| Código     | Controle de Fluxo                                         |             |                      |
| Código     | Controle de Fluxo                                         |             |                      |
| Execução   | Introdução, Registro de Ativação                          |             |                      |
| Execução   | Chamada e retorno de Função, Passagem de parâmetros       |             | Início E7 (Otim.)    |
| Otimização | Introdução, Janela e Grafos de Fluxo                      |             |                      |
| Otimização | Grafos de Fluxo e Redução de potência                     |             |                      |
|            | Revisão                                                   |             |                      |
|            | P2 (Presencial, G1 e G2)                                  | Auditório   |                      |
| Fechamento | Fechamento e reflexão final (Presencial, G1)              | Teórica     |                      |
| Fechamento | Fechamento e reflexão final (Presencial, G2)              | Teórica     |                      |
|            | PR                                                        |             |                      |
...
dataDaRecuperação <- ymd("2022-07-17");
