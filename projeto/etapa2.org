...
** Listas das estruturas de controle de fluxo

Não podem ser vazias.

** Expressão inteira entre colchetes

Tem que ser uma expressão.

** Bloco dentro de comandos de controle de fluxo

Não tem ponto-e-vírgula.

** Comandos dentro do for

Nas duas listas dentro do =for=, não podem aparecer comandos simples que
contenham vírgulas, como o =output= e o =input=, nem comando =case=.

** Listas de expressões no comando =output=
