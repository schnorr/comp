...
apenas com atributos sintetizados, não há como escapar de realizar em
mais de uma passagem, sendo esta talvez uma desvantagem.
...
manter em memória aquela variável menos utilizada.
