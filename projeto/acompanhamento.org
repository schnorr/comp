...
** Testes automáticos (preliminar)

A tabela abaixo mostra os resultados preliminares dos testes
...
- Aguarda-se resubmissão dos grupos sem nota E5.S (Subjetiva)
  - Focar nos melhoramentos que dão origem a nota E5.O
- O Grupo =Rho= entregará em atraso.
