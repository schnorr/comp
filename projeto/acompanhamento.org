...
A coluna ~TDM~ indica a distância da árvore gerada pelo grupo da árvore
de referência. Abaixo uma descrição mais completa da codificação. A
coluna ~VG~ indica a quantidade de bytes de vazamento de memória (na
variável ~VGCUTIN~), calculada da seguinte forma:
...
| Alpha   | ~asl53~        |   1 |     0 | TRUE     |
| Alpha   | ~asl54~        |   1 |     0 | TRUE     |
...
| Alpha   | ~i_e3_006.ptg~ |   2 |     0 | TRUE     |
| Alpha   | ~i_e3_008.ptg~ |   1 |     0 | TRUE     |
...
| Alpha   | ~i_e3_037.ptg~ |   2 |     0 | TRUE     |
| Alpha   | ~i_e3_038.ptg~ |   2 |     0 | TRUE     |
...
| Kappa   | ~asl47~        |   1 |     0 | TRUE     |
| Kappa   | ~asl48~        |   1 |     0 | TRUE     |
...
| Kappa   | ~i_e3_006.ptg~ |   2 |     0 | TRUE     |
| Kappa   | ~i_e3_008.ptg~ |   1 |     0 | TRUE     |
...
| Tau     | ~i_e3_006.ptg~ |   2 |     0 | TRUE     |
| Tau     | ~i_e3_008.ptg~ |   1 |     0 | TRUE     |
...
| Theta   | ~asl43~        |   1 |     0 | TRUE     |
| Theta   | ~asl44~        |   1 |     0 | TRUE     |
| Theta   | ~asl46~        |   1 |     0 | TRUE     |
| Theta   | ~asl47~        |   3 |     0 | FALSE    |
| Theta   | ~asl48~        |   6 |     0 | FALSE    |
| Theta   | ~asl53~        |   0 |     0 | TRUE     |
| Theta   | ~asl54~        |   3 |     0 | FALSE    |
| Theta   | ~asl56~        |   1 |     0 | TRUE     |
| Theta   | ~asl57~        |   1 |     0 | TRUE     |
| Theta   | ~asl58~        |   1 |     0 | TRUE     |
| Theta   | ~asl59~        |   0 |     0 | TRUE     |
| Theta   | ~asl60~        |   0 |     0 | TRUE     |
| Theta   | ~asl62~        |   1 |     0 | TRUE     |
| Theta   | ~asl63~        |   3 |     0 | FALSE    |
| Theta   | ~asl65~        |   1 |     0 | TRUE     |
| Theta   | ~asl66~        |   2 |     0 | TRUE     |
| Theta   | ~asl76~        |   7 |     0 | FALSE    |
| Theta   | ~asl77~        |   1 |     0 | TRUE     |
| Theta   | ~asl78~        |   8 |     0 | FALSE    |
| Theta   | ~asl79~        |   5 |     0 | FALSE    |
| Theta   | ~asl80~        |  10 |     0 | FALSE    |
| Theta   | ~asl81~        |   0 |     0 | TRUE     |
| Theta   | ~asl114~       |   0 |     0 | TRUE     |
| Theta   | ~asl138~       |   2 |     0 | TRUE     |
| Theta   | ~asl139~       |   2 |     0 | TRUE     |
| Theta   | ~asl140~       |   2 |     0 | TRUE     |
| Theta   | ~asl141~       |   2 |     0 | TRUE     |
| Theta   | ~asl142~       |   2 |     0 | TRUE     |
| Theta   | ~asl143~       |   2 |     0 | TRUE     |
| Theta   | ~asl144~       |   2 |     0 | TRUE     |
...
| Theta   | ~i_e3_003.ptg~ |   1 |     0 | TRUE     |
| Theta   | ~i_e3_004.ptg~ | 253 |     0 | FALSE    |
| Theta   | ~i_e3_005.ptg~ |   1 |     0 | TRUE     |
| Theta   | ~i_e3_006.ptg~ |   3 |     0 | FALSE    |
| Theta   | ~i_e3_008.ptg~ |   2 |     0 | TRUE     |
| Theta   | ~i_e3_013.ptg~ |   2 |     0 | TRUE     |
| Theta   | ~i_e3_014.ptg~ |   7 |     0 | FALSE    |
| Theta   | ~i_e3_015.ptg~ | 253 |    70 | FALSE    |
| Theta   | ~i_e3_020.ptg~ |   1 |     0 | TRUE     |
| Theta   | ~i_e3_021.ptg~ |   1 |     0 | TRUE     |
| Theta   | ~i_e3_022.ptg~ |   1 |     0 | TRUE     |
| Theta   | ~i_e3_023.ptg~ |   1 |     0 | TRUE     |
| Theta   | ~i_e3_024.ptg~ |   1 |     0 | TRUE     |
...
| Zeta    | ~i_e3_006.ptg~ |   2 |     0 | TRUE     |
| Zeta    | ~i_e3_008.ptg~ |   1 |     0 | TRUE     |
...
** Descrição dos códigos de resultados TDM

Linhas onde ~TDMTEXT~ tem um número em ponto-flutuante indicam a
distância em número de operações da árvore do grupo para a árvore de
referência. Linhas onde ~TDMTEXT~ tem um texto em inglês indicam saída
onde a distância TDM não pode ser calculada (no caso de 254, 253 e
252), ou é 0 por definição pois o teste esperava que a árvore fosse
vazia (código 0). O resultado ideal é quando o código TDM vale zero.

| TDM | TDMTEXT                                            |
|-----+----------------------------------------------------|
| 254 | File does not exist.                               |
| 253 | Informed Tree is None, while Reference Tree isn't. |
| 252 | Informed Tree isn't None, while Reference Tree is. |
|  99 | (99.0,  ...                                        |
|  93 | (93.0,  ...                                        |
|  79 | (79.0,  ...                                        |
|  78 | (78.0,  ...                                        |
...
|   2 | (2.0,  ...                                         |
|   1 | (1.0,  ...                                         |
|   0 | Both trees are None, so equal.                     |
|   0 | (0.0,  ...                                         |
...
#+begin_src shell :results output
TDMTEXT=$($TDM_SCRIPT $CSV_GEN $CSV_REF)
TDM=$?
#+end_src

Onde ~$CSV_GEN~ é a solução do grupo, ~$CSV_REF~ é a árvore de referência.

Mais detalhes sobre as dependências do script abaixo em:
- https://github.com/timtadh/zhang-shasha

#+BEGIN_SRC python :tangle tdm.python :tangle-mode (identity #o755)
#!/usr/bin/python
import os.path
import sys
import pandas
...
def print_my_tree (tree):
    print_my_tree_depth (tree, 0)

def print_my_tree_depth (tree, depth):
    l = 0
    print depth, tree.get_label(tree)
    for kid in tree.get_children(tree):
    	print_my_tree_depth(kid, depth+1)

if len(sys.argv) != 3:
    print "Two CSV filenames must be provided."
    sys.exit(255)
...
B = read_csv_to_tree (sys.argv[2])

if A is None and B is None:
    print "Both trees are None, so equal."
    sys.exit(0)
if (A is None and B is not None):
    print "Informed Tree is None, while Reference Tree isn't."
    sys.exit(253)
if (A is not None and B is None):
    print "Informed Tree isn't None, while Reference Tree is."
    sys.exit(252)
...
val = distance(A, B, Node.get_children, cost_insert, cost_remove, cost_update, return_operations=True)
print val
sys.exit(int(val[0]))
#+END_SRC
