...
correspondente. No caso dos literais caracter e string, deve ser
registrado na tabela de símbolo o lexema sem as aspas (sejam elas
simples ou duplas).
...
entre aspas simples como por exemplo o ='a'=, ='='= e ='+'=. Literais do tipo
=string= são qualquer sequência de caracteres entre aspas duplas, como
por exemplo ="meu nome"= ou ="x = 3;"= . Os literais do tipo =char= e =string=
devem ser inseridos na tabela de símbolos sem as aspas que os
identificam no código fonte.
